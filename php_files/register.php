...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(!empty($kullanici_adi) && !empty($email) && !empty($sifre)) {
        ...
        try {
            ...
            $sorgu->execute([$kullanici_adi, $email, $hashed_sifre]);
            $mesaj = "<div class='alert alert-success'>Kayıt başarılı! Şimdi giriş yapabilirsiniz.</div>";
        } catch(PDOException $e) {
            $mesaj = "<div class='alert alert-danger'>Kullanıcı adı veya E-posta zaten kullanımda!</div>";
        }
    } else {
    ...
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card shadow">
                <div class="card-header bg-primary text-white"><h4 class="mb-0">Kayıt Ol</h4></div>
                <div class="card-body">
                    <?php echo $mesaj; ?>
                    <form action="" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group password-group">
                                <input type="password" name="sifre" id="registerPassword" class="form-control" required>
                                <button class="btn" type="button" onclick="togglePasswordVisibility('registerPassword', this)">Göster</button>
                            </div>
                        </div>
